...
<body>
	...
	<div class="info">
		...
		<div id="tables" class="main_container">
		...
		<div id="tables2">
			...
			<div class="container4">  		
				<table>
					...
					<tr>
						<td><input type="text" id="div과목명" class="form-control" name="class_name" value=""></td>
						<td><input type="text" id="div이수" class="form-control" name="class_type" value=""></td>
						<td><input type="text" id="div학점" class="form-control" name="grade_regcredit" value=""></td>
						<td><input type="text" id="div점수" class="form-control" name="grade_score" value=""></td>
						<td><input type="text" id="div등급" class="form-control" name="rank" value=""></td>
					</tr>
				</table>
			</div>
		</div>
